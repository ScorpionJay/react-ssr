...
if (process.env.NODE_ENV === "production") {
  Config = {
    ...
    musicSearchAPI:
      "/musicSearch/api/v3/search/song?page=PAGE&pagesize=30&keyword=KEYWORD",
    playListAPI: "/api/album/id",
    musicDetail: "/api/musicDetail/HASH",
    ...
    rankListAPI:
      "cdnbj/api/v3/rank/list?plat=2&withsong=1&showtype=2&parentid=0&apiver=4&version=8550",
